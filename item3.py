...
def signup_v1():
    ...
    c = conn.cursor()
    c.execute('''CREATE TABLE IF NOT EXISTIS USER_PLAIN
...
def login_v1():
    ...
    if request.method == 'POST':
        if verify_plain(request.form['username'], request.form['password']):
            ...
            error = 'Usuario/contrasena invalidos'
    else:
...
def signup_v2():
    ...
    try:
        ...
        return "username has been registered"
    print('nombre de usuario: ', request.form['username'],
    'contrasena: ', request.form['password'], 'hash: ', hash_value)
